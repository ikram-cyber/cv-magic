...
export const FormEditor = {
    init() {
        ...
        ['name', 'dob', 'role', 'email', 'phone', 'address', 'link', 'summary', 'skills', 'education', 'certifications', 'projects', 'languages', 'organizations', 'readiness', 'recipient', 'career-status', 'recipient-title'].forEach(key => {
