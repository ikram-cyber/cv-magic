...
export const TemplateCLASSIC = {
    render(data) {
        const t = Magic.dict[data.lang || 'id']; // Tarik kamus
                ...
                <div class="flex gap-6 mb-6">
                    ...
                    <div class="flex-1 pt-2">
                        ...
                        <table class="text-sm w-full">
                            <tr><td class="w-28 pb-2 font-bold align-top pt-0.5"><span class="inline-block w-1.5 h-1.5 rounded-full mr-2 align-middle mb-0.5" style="background-color: ${data.color || '#000'}"></span>${t.name}</td><td class="w-3 pb-2 align-top pt-0.5">:</td><td class="pb-2 align-top pt-0.5">${data.name || '-'}</td></tr>
                            <tr><td class="w-28 pb-2 font-bold align-top pt-0.5"><span class="inline-block w-1.5 h-1.5 rounded-full mr-2 align-middle mb-0.5" style="background-color: ${data.color || '#000'}"></span>${t.dob}</td><td class="w-3 pb-2 align-top pt-0.5">:</td><td class="pb-2 align-top pt-0.5">${data.dob || '-'}</td></tr>
                            <tr><td class="w-28 pb-2 font-bold align-top pt-0.5"><span class="inline-block w-1.5 h-1.5 rounded-full mr-2 align-middle mb-0.5" style="background-color: ${data.color || '#000'}"></span>${t.phone}</td><td class="w-3 pb-2 align-top pt-0.5">:</td><td class="pb-2 align-top pt-0.5">${data.phone || '-'}</td></tr>
                            <tr><td class="w-28 pb-2 font-bold align-top pt-0.5"><span class="inline-block w-1.5 h-1.5 rounded-full mr-2 align-middle mb-0.5" style="background-color: ${data.color || '#000'}"></span>${t.address}</td><td class="w-3 pb-2 align-top pt-0.5">:</td><td class="pb-2 align-top pt-0.5 leading-relaxed text-justify pr-4">${data.address || '-'}</td></tr>
                        </table>
                    </div>
                </div>
