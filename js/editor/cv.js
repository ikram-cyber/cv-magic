document.addEventListener('DOMContentLoaded', () => {
    // --- STATE MANAGER ---
    let cvData = { photo: '', experiences: [], educations: [], projects: [] };
    ...
    document.getElementById('btn-export-cv').onclick = () => {
        html2pdf().set({ margin:0, filename:`${getVal('name') || 'CV'}_IkramCyber.pdf`, image:{type:'jpeg',quality:0.98}, html2canvas:{scale:2,useCORS:true}, jsPDF:{unit:'mm',format:'a4',orientation:'portrait'} }).from(paper).save();
    };
